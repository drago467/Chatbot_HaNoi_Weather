...
def test_prompt_format_placeholders_intact():
    ...
    required = (
        ...
        "{day_before_yesterday_weekday}", "{day_before_yesterday_date}", "{day_before_yesterday_iso}",
        "{day_after_tomorrow_weekday}", "{day_after_tomorrow_date}", "{day_after_tomorrow_iso}",
...
def test_prompt_format_smoke():
    ...
    dummy = {
        ...
        "day_before_yesterday_weekday": "Thứ Bảy", "day_before_yesterday_date": "30/12",
        "day_before_yesterday_iso": "2025-12-30",
        "day_after_tomorrow_weekday": "Thứ Tư", "day_after_tomorrow_date": "03/01",
        "day_after_tomorrow_iso": "2026-01-03",
